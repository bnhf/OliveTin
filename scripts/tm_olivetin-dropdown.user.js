  ...
  const ACTIONS = [
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "adbtuner_host_port", label: "ADBTuner Host:Port", default: "${PORTAINER_HOST}:5592", description: "ADBTuner host:port or ip:port" },
  ...
  const ONE_CLICK_ACTIONS = [
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TUNER3_IP", label: "Tuner 3 IP", default: "#", description: "Streaming device #3 hostname:port (# for none)" },
        { name: "ENCODER3_URL", label: "Encoder 3 URL", default: "#", description: "Full URL for tuner #3 (# for none)" },
        { name: "TUNER4_IP", label: "Tuner 4 IP", default: "#", description: "Streaming device #4 hostname:port (# for none)" },
        { name: "ENCODER4_URL", label: "Encoder 4 URL", default: "#", description: "Full URL for tuner #4 (# for none)" },
        { name: "TUNER5_IP", label: "Tuner 5 IP", default: "#", description: "Streaming device #5 hostname:port (# for none)" },
        { name: "ENCODER5_URL", label: "Encoder 5 URL", default: "#", description: "Full URL for tuner #5 (# for none)" },
        { name: "TUNER6_IP", label: "Tuner 6 IP", default: "#", description: "Streaming device #6 hostname:port (# for none)" },
        { name: "ENCODER6_URL", label: "Encoder 6 URL", default: "#", description: "Full URL for tuner #6 (# for none)" },
        { name: "TUNER7_IP", label: "Tuner 7 IP", default: "#", description: "Streaming device #7 hostname:port (# for none)" },
        { name: "ENCODER7_URL", label: "Encoder 7 URL", default: "#", description: "Full URL for tuner #7 (# for none)" },
        { name: "TUNER8_IP", label: "Tuner 8 IP", default: "#", description: "Streaming device #8 hostname:port (# for none)" },
        { name: "ENCODER8_URL", label: "Encoder 8 URL", default: "#", description: "Full URL for tuner #8 (# for none)" },
        { name: "TUNER9_IP", label: "Tuner 9 IP", default: "#", description: "Streaming device #9 hostname:port (# for none)" },
        { name: "ENCODER9_URL", label: "Encoder 9 URL", default: "#", description: "Full URL for tuner #9 (# for none)" },
        { name: "STREAMER_APP", label: "Streamer App", default: "scripts/firetv/directv", description: "scripts/streamer/app path" },
        { name: "CHANNELSIP", label: "Channels IP", default: "media-server8", description: "Hostname/IP of Channels DVR server" },
    ...
    {
      id: "ah4c_directv_grabber",
      label: "ah4c DirecTV M3U",
      title: "Create an ah4c DirecTV M3U",
      arguments: [
        { name: "CURL_COMMAND", label: "Curl Command", placeholder: "Paste your DirecTV curl command", description: "Custom curl command to grab your specific DirecTV channel lineup" },
        {
          name: "URL_STYLE",
          label: "URL Style",
          description: "The type of ah4c URL to be generated in the M3U for each channel",
          default: "true",
          options: [
            { display: "Deep Links", value: "true" },
            { display: "Channel Numbers", value: "false" },
          ],
        },
      ],
    },
      ...
      arguments: [
        {
          ...
          options: [
            ...
            { display: "ah4c DirecTV", value: "ah4c_directv_grabber" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TZ", label: "Timezone", default: "${TZ}", description: "Your local timezone in Linux tz format" },
        { name: "VC_RESOLVER_BASE", label: "Base URL", default: "http://${PORTAINER_HOST}:8094", description: "Base URL for this project" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TZ", label: "Timezone", default: "${TZ}", description: "Your local timezone in Linux tz format" },
        { name: "SERVER_URL", label: "Server URL", default: "http://${PORTAINER_HOST}:6655", description: "FruitDeepLinks base URL" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "FRUIT_HOST", label: "FruitDeepLinks Host", default: "${PORTAINER_HOST}", description: "Hostname or IP of host running FruitDeepLinks" },
        { name: "FRUIT_PORT", label: "FruitDeepLinks Port", default: "6655", description: "Port FruitDeepLinks is available on" },
        {
          ...
          options: [
            ...
            { display: "MLB.TV", value: "MLB.TV~mlb~com.bamnetworks.mobile.android.gameday.atbat~com.bamnetworks.mobile.android.gameday.atbat" },
        ...
        },
        {
          ...
          options: [
            ...
            { display: "FruitDeepLinks - AppleTV (FireTV and AndroidTV)", value: "8cf23241-09e3-4b79-90fe-576086707462~custom" },
            { display: "FruitDeepLinks - ESPN+ (FireTV and AndroidTV)", value: "51af5028-092f-4ddc-b4ea-d5e5fca58cac~custom" },
            { display: "FruitDeepLinks - HBO Max (FireTV and AndroidTV)", value: "3d0ebcea-2eef-401d-a737-4df27aca5373~custom" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TIMEZONE", label: "Timezone", default: "${TZ}", description: "In Linux Continent/City format" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TIMEZONE", label: "Timezone", default: "${TZ}", description: "Your local timezone in Linux tz format" },
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TZ", label: "Timezone", default: "${TZ}", description: "Your local timezone (Continent/City format)" },
        { name: "HOST_DIR", label: "Host Dir", default: "/data", description: "Parent directory for persistent data" },
      ],
    },
    {
    ...
    },
    {
      ...
      arguments: [
        ...
        { name: "TZ", label: "Timezone", default: "${TZ}", description: "Your local timezone in Linux tz format (Continent/City)" },
        { name: "HOST_DIR", label: "Host Dir", default: "/data", description: "Parent directory for persistent data" },
      ],
    },
    {
